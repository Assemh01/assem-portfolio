...
const Header = ({ handleWorkScroll, handleSkillsScroll, handleAboutScroll }) => {
  ...
  const onChat = router.pathname === "/chat";
  const onResume = router.pathname === "/resume";
          ...
          <>
            ...
            >
              <div className="grid grid-cols-1">
                ...
                {showResume && (
                  <Button
                    onClick={() => !onResume && router.push("/resume")}
                    classes={
                      onResume
                ...
                <Button
                  onClick={() => !onChat && router.push("/chat")}
                  classes={
                    onChat
                      ? "opacity-100 underline underline-offset-4"
                      : ""
                ...
                <Button
                  onClick={() =>
                    window.open("mailto:assem.h2001@gmail.com")
                  }
                >
                  Contact
                </Button>
